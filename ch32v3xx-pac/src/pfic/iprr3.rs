#[doc = "Register `IPRR3` writer"]
pub type W = crate::W<IPRR3_SPEC>;
#[doc = "Field `PENDRESET` writer - PENDRESET"]
pub type PENDRESET_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl W {
    #[doc = "Bits 0:31 - PENDRESET"]
    #[inline(always)]
    #[must_use]
    pub fn pendreset(&mut self) -> PENDRESET_W<IPRR3_SPEC, 0> {
...
#[doc = "`write(|w| ..)` method takes [`iprr3::W`](W) writer structure"]
impl crate::Writable for IPRR3_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets IPRR3 to value 0"]
