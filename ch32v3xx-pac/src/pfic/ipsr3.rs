...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pendset(&mut self) -> PENDSET_W<IPSR3_SPEC, 0> {
        PENDSET_W::new(self)
    }
...
#[doc = "`write(|w| ..)` method takes [`ipsr3::W`](W) writer structure"]
impl crate::Writable for IPSR3_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets IPSR3 to value 0"]
