#[doc = "Register `IENR4` writer"]
pub type W = crate::W<IENR4_SPEC>;
#[doc = "Field `INTEN` writer - INTEN"]
pub type INTEN_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
impl W {
    #[doc = "Bits 0:7 - INTEN"]
    #[inline(always)]
    #[must_use]
    pub fn inten(&mut self) -> INTEN_W<IENR4_SPEC, 0> {
        INTEN_W::new(self)
    }
...
#[doc = "`write(|w| ..)` method takes [`ienr4::W`](W) writer structure"]
impl crate::Writable for IENR4_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets IENR4 to value 0"]
