#[doc = "Register `IRER3` writer"]
pub type W = crate::W<IRER3_SPEC>;
#[doc = "Field `INTRSET` writer - INTRSET"]
pub type INTRSET_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl W {
    #[doc = "Bits 0:31 - INTRSET"]
    #[inline(always)]
    #[must_use]
    pub fn intrset(&mut self) -> INTRSET_W<IRER3_SPEC, 0> {
        INTRSET_W::new(self)
    }
...
#[doc = "`write(|w| ..)` method takes [`irer3::W`](W) writer structure"]
impl crate::Writable for IRER3_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets IRER3 to value 0"]
