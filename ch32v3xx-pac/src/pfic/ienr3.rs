#[doc = "Register `IENR3` writer"]
pub type W = crate::W<IENR3_SPEC>;
#[doc = "Field `INTEN` writer - INTEN"]
pub type INTEN_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl W {
    #[doc = "Bits 0:31 - INTEN"]
    #[inline(always)]
    #[must_use]
    pub fn inten(&mut self) -> INTEN_W<IENR3_SPEC, 0> {
        INTEN_W::new(self)
    }
...
#[doc = "`write(|w| ..)` method takes [`ienr3::W`](W) writer structure"]
impl crate::Writable for IENR3_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets IENR3 to value 0"]
