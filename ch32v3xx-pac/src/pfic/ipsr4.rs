#[doc = "Register `IPSR4` writer"]
pub type W = crate::W<IPSR4_SPEC>;
#[doc = "Field `PENDSET` writer - PENDSET"]
pub type PENDSET_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
impl W {
    #[doc = "Bits 0:7 - PENDSET"]
    #[inline(always)]
    #[must_use]
    pub fn pendset(&mut self) -> PENDSET_W<IPSR4_SPEC, 0> {
        PENDSET_W::new(self)
    }
...
#[doc = "`write(|w| ..)` method takes [`ipsr4::W`](W) writer structure"]
impl crate::Writable for IPSR4_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets IPSR4 to value 0"]
