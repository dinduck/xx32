...
pub type AISE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type NISE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `IPLE` reader - 10M Physical layer connection"]
pub type IPLE_R = crate::BitReader;
#[doc = "Field `IPLE` writer - 10M Physical layer connection"]
pub type IPLE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tie(&mut self) -> TIE_W<DMAIER_SPEC, 0> {
        TIE_W::new(self)
    }
    #[doc = "Bit 1 - Transmit process stopped interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn tpsie(&mut self) -> TPSIE_W<DMAIER_SPEC, 1> {
        TPSIE_W::new(self)
    }
    #[doc = "Bit 2 - Transmit buffer unavailable interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn tbuie(&mut self) -> TBUIE_W<DMAIER_SPEC, 2> {
        TBUIE_W::new(self)
    }
    #[doc = "Bit 3 - Transmit jabber timeout interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn tjtie(&mut self) -> TJTIE_W<DMAIER_SPEC, 3> {
        TJTIE_W::new(self)
    }
    #[doc = "Bit 4 - Overflow interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn roie(&mut self) -> ROIE_W<DMAIER_SPEC, 4> {
        ROIE_W::new(self)
    }
    #[doc = "Bit 5 - Underflow interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn tuie(&mut self) -> TUIE_W<DMAIER_SPEC, 5> {
        TUIE_W::new(self)
    }
    #[doc = "Bit 6 - Receive interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn rie(&mut self) -> RIE_W<DMAIER_SPEC, 6> {
        RIE_W::new(self)
    }
    #[doc = "Bit 7 - Receive buffer unavailable interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn rbuie(&mut self) -> RBUIE_W<DMAIER_SPEC, 7> {
        RBUIE_W::new(self)
    }
    #[doc = "Bit 8 - Receive process stopped interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn rpsie(&mut self) -> RPSIE_W<DMAIER_SPEC, 8> {
        RPSIE_W::new(self)
    }
    #[doc = "Bit 9 - receive watchdog timeout interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn rwtie(&mut self) -> RWTIE_W<DMAIER_SPEC, 9> {
        RWTIE_W::new(self)
    }
    #[doc = "Bit 10 - Early transmit interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn etie(&mut self) -> ETIE_W<DMAIER_SPEC, 10> {
        ETIE_W::new(self)
    }
    #[doc = "Bit 13 - Fatal bus error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn fbeie(&mut self) -> FBEIE_W<DMAIER_SPEC, 13> {
        FBEIE_W::new(self)
    }
    #[doc = "Bit 14 - Early receive interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn erie(&mut self) -> ERIE_W<DMAIER_SPEC, 14> {
        ERIE_W::new(self)
    }
    #[doc = "Bit 15 - Abnormal interrupt summary enable"]
    #[inline(always)]
    #[must_use]
    pub fn aise(&mut self) -> AISE_W<DMAIER_SPEC, 15> {
        AISE_W::new(self)
    }
    #[doc = "Bit 16 - Normal interrupt summary enable"]
    #[inline(always)]
    #[must_use]
    pub fn nise(&mut self) -> NISE_W<DMAIER_SPEC, 16> {
        NISE_W::new(self)
    }
    #[doc = "Bit 31 - 10M Physical layer connection"]
    #[inline(always)]
    #[must_use]
    pub fn iple(&mut self) -> IPLE_W<DMAIER_SPEC, 31> {
        IPLE_W::new(self)
    }
