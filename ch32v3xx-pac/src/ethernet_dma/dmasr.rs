...
pub type TPSS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TBUS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TJTS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TUS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RBUS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RPSS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type IPLS_R = crate::BitReader;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ts(&mut self) -> TS_W<DMASR_SPEC, 0> {
        TS_W::new(self)
    }
    #[doc = "Bit 1 - Transmit process stopped status"]
    #[inline(always)]
    #[must_use]
    pub fn tpss(&mut self) -> TPSS_W<DMASR_SPEC, 1> {
        TPSS_W::new(self)
    }
    #[doc = "Bit 2 - Transmit buffer unavailable status"]
    #[inline(always)]
    #[must_use]
    pub fn tbus(&mut self) -> TBUS_W<DMASR_SPEC, 2> {
        TBUS_W::new(self)
    }
    #[doc = "Bit 3 - Transmit jabber timeout status"]
    #[inline(always)]
    #[must_use]
    pub fn tjts(&mut self) -> TJTS_W<DMASR_SPEC, 3> {
        TJTS_W::new(self)
    }
    #[doc = "Bit 4 - Receive overflow status"]
    #[inline(always)]
    #[must_use]
    pub fn ros(&mut self) -> ROS_W<DMASR_SPEC, 4> {
        ROS_W::new(self)
    }
    #[doc = "Bit 5 - Transmit underflow status"]
    #[inline(always)]
    #[must_use]
    pub fn tus(&mut self) -> TUS_W<DMASR_SPEC, 5> {
        TUS_W::new(self)
    }
    #[doc = "Bit 6 - Receive status"]
    #[inline(always)]
    #[must_use]
    pub fn rs(&mut self) -> RS_W<DMASR_SPEC, 6> {
        RS_W::new(self)
    }
    #[doc = "Bit 7 - Receive buffer unavailable status"]
    #[inline(always)]
    #[must_use]
    pub fn rbus(&mut self) -> RBUS_W<DMASR_SPEC, 7> {
        RBUS_W::new(self)
    }
    #[doc = "Bit 8 - Receive process stopped status"]
    #[inline(always)]
    #[must_use]
    pub fn rpss(&mut self) -> RPSS_W<DMASR_SPEC, 8> {
        RPSS_W::new(self)
    }
    #[doc = "Bit 9 - Receive watchdog timeout status"]
    #[inline(always)]
    #[must_use]
    pub fn pwts(&mut self) -> PWTS_W<DMASR_SPEC, 9> {
        PWTS_W::new(self)
    }
    #[doc = "Bit 10 - Early transmit status"]
    #[inline(always)]
    #[must_use]
    pub fn ets(&mut self) -> ETS_W<DMASR_SPEC, 10> {
        ETS_W::new(self)
    }
    #[doc = "Bit 13 - Fatal bus error status"]
    #[inline(always)]
    #[must_use]
    pub fn fbes(&mut self) -> FBES_W<DMASR_SPEC, 13> {
        FBES_W::new(self)
    }
    #[doc = "Bit 14 - Early receive status"]
    #[inline(always)]
    #[must_use]
    pub fn ers(&mut self) -> ERS_W<DMASR_SPEC, 14> {
        ERS_W::new(self)
    }
    #[doc = "Bit 15 - Abnormal interrupt summary"]
    #[inline(always)]
    #[must_use]
    pub fn ais(&mut self) -> AIS_W<DMASR_SPEC, 15> {
        AIS_W::new(self)
    }
    #[doc = "Bit 16 - Normal interrupt summary"]
    #[inline(always)]
    #[must_use]
    pub fn nis(&mut self) -> NIS_W<DMASR_SPEC, 16> {
        NIS_W::new(self)
    }
