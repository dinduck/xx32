...
pub type R = crate::R<CNTR9_SPEC>;
#[doc = "Register `CNTR9` writer"]
pub type W = crate::W<CNTR9_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ndt(&mut self) -> NDT_W<CNTR9_SPEC, 0> {
        NDT_W::new(self)
    }
...
#[doc = "DMA channel 9 number of data register used in ch32v30x_D8/D8C\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cntr9::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cntr9::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
