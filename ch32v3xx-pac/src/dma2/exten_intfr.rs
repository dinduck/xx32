...
pub type R = crate::R<EXTEN_INTFR_SPEC>;
...
pub type HTIF9_R = crate::BitReader;
...
pub type HTIF10_R = crate::BitReader;
...
pub type HTIF11_R = crate::BitReader;
...
#[doc = "DMA2 EXTEN interrupt status register (DMA_INTFR)used in ch32v30x_D8/D8C\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`exten_intfr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
