...
pub type R = crate::R<CNTR11_SPEC>;
#[doc = "Register `CNTR11` writer"]
pub type W = crate::W<CNTR11_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ndt(&mut self) -> NDT_W<CNTR11_SPEC, 0> {
        NDT_W::new(self)
    }
