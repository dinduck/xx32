...
pub type R = crate::R<PADDR9_SPEC>;
#[doc = "Register `PADDR9` writer"]
pub type W = crate::W<PADDR9_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pa(&mut self) -> PA_W<PADDR9_SPEC, 0> {
        PA_W::new(self)
    }
...
#[doc = "DMA channel 7 peripheral address register used in ch32v30x_D8/D8C\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`paddr9::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`paddr9::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
