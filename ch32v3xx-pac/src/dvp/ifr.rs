...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rb_dvp_if_str_frm(&mut self) -> RB_DVP_IF_STR_FRM_W<IFR_SPEC, 0> {
        RB_DVP_IF_STR_FRM_W::new(self)
    }
    #[doc = "Bit 1 - DVP row received done interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn rb_dvp_if_row_done(&mut self) -> RB_DVP_IF_ROW_DONE_W<IFR_SPEC, 1> {
        RB_DVP_IF_ROW_DONE_W::new(self)
    }
    #[doc = "Bit 2 - DVP frame received done interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn rb_dvp_if_frm_done(&mut self) -> RB_DVP_IF_FRM_DONE_W<IFR_SPEC, 2> {
        RB_DVP_IF_FRM_DONE_W::new(self)
    }
    #[doc = "Bit 3 - DVP receive fifo overflow interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn rb_dvp_if_fifo_ov(&mut self) -> RB_DVP_IF_FIFO_OV_W<IFR_SPEC, 3> {
        RB_DVP_IF_FIFO_OV_W::new(self)
    }
    #[doc = "Bit 4 - DVP frame stop interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn rb_dvp_if_stp_frm(&mut self) -> RB_DVP_IF_STP_FRM_W<IFR_SPEC, 4> {
