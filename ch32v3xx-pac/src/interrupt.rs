...
interrupts"]
    ...
    UART5 = 69,
    #[doc = "70 - TIM6 Basic interrupt"]
    TIM6 = 70,
    #[doc = "71 - TIM8 Basic interrupt"]
    TIM7 = 71,
...
impl Interrupt {
    ...
    pub fn try_from(value: u8) -> Result<Self, TryFromInterruptError> {
        match value {
            ...
            34 => Ok(Interrupt::ADC),
            35 => Ok(Interrupt::USB_HP_CAN1_TX),
            36 => Ok(Interrupt::USB_LP_CAN1_RX0),
            ...
            70 => Ok(Interrupt::TIM6),
            71 => Ok(Interrupt::TIM7),
