...
pub type PR19_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pr0(&mut self) -> PR0_W<INTFR_SPEC, 0> {
        PR0_W::new(self)
    }
    #[doc = "Bit 1 - Pending bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn pr1(&mut self) -> PR1_W<INTFR_SPEC, 1> {
        PR1_W::new(self)
    }
    #[doc = "Bit 2 - Pending bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn pr2(&mut self) -> PR2_W<INTFR_SPEC, 2> {
        PR2_W::new(self)
    }
    #[doc = "Bit 3 - Pending bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn pr3(&mut self) -> PR3_W<INTFR_SPEC, 3> {
        PR3_W::new(self)
    }
    #[doc = "Bit 4 - Pending bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn pr4(&mut self) -> PR4_W<INTFR_SPEC, 4> {
        PR4_W::new(self)
    }
    #[doc = "Bit 5 - Pending bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn pr5(&mut self) -> PR5_W<INTFR_SPEC, 5> {
        PR5_W::new(self)
    }
    #[doc = "Bit 6 - Pending bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn pr6(&mut self) -> PR6_W<INTFR_SPEC, 6> {
        PR6_W::new(self)
    }
    #[doc = "Bit 7 - Pending bit 7"]
    #[inline(always)]
    #[must_use]
    pub fn pr7(&mut self) -> PR7_W<INTFR_SPEC, 7> {
        PR7_W::new(self)
    }
    #[doc = "Bit 8 - Pending bit 8"]
    #[inline(always)]
    #[must_use]
    pub fn pr8(&mut self) -> PR8_W<INTFR_SPEC, 8> {
        PR8_W::new(self)
    }
    #[doc = "Bit 9 - Pending bit 9"]
    #[inline(always)]
    #[must_use]
    pub fn pr9(&mut self) -> PR9_W<INTFR_SPEC, 9> {
        PR9_W::new(self)
    }
    #[doc = "Bit 10 - Pending bit 10"]
    #[inline(always)]
    #[must_use]
    pub fn pr10(&mut self) -> PR10_W<INTFR_SPEC, 10> {
        PR10_W::new(self)
    }
    #[doc = "Bit 11 - Pending bit 11"]
    #[inline(always)]
    #[must_use]
    pub fn pr11(&mut self) -> PR11_W<INTFR_SPEC, 11> {
        PR11_W::new(self)
    }
    #[doc = "Bit 12 - Pending bit 12"]
    #[inline(always)]
    #[must_use]
    pub fn pr12(&mut self) -> PR12_W<INTFR_SPEC, 12> {
        PR12_W::new(self)
    }
    #[doc = "Bit 13 - Pending bit 13"]
    #[inline(always)]
    #[must_use]
    pub fn pr13(&mut self) -> PR13_W<INTFR_SPEC, 13> {
        PR13_W::new(self)
    }
    #[doc = "Bit 14 - Pending bit 14"]
    #[inline(always)]
    #[must_use]
    pub fn pr14(&mut self) -> PR14_W<INTFR_SPEC, 14> {
        PR14_W::new(self)
    }
    #[doc = "Bit 15 - Pending bit 15"]
    #[inline(always)]
    #[must_use]
    pub fn pr15(&mut self) -> PR15_W<INTFR_SPEC, 15> {
        PR15_W::new(self)
    }
    #[doc = "Bit 16 - Pending bit 16"]
    #[inline(always)]
    #[must_use]
    pub fn pr16(&mut self) -> PR16_W<INTFR_SPEC, 16> {
        PR16_W::new(self)
    }
    #[doc = "Bit 17 - Pending bit 17"]
    #[inline(always)]
    #[must_use]
    pub fn pr17(&mut self) -> PR17_W<INTFR_SPEC, 17> {
        PR17_W::new(self)
    }
    #[doc = "Bit 18 - Pending bit 18"]
    #[inline(always)]
    #[must_use]
    pub fn pr18(&mut self) -> PR18_W<INTFR_SPEC, 18> {
        PR18_W::new(self)
    }
    #[doc = "Bit 19 - Pending bit 19"]
    #[inline(always)]
    #[must_use]
    pub fn pr19(&mut self) -> PR19_W<INTFR_SPEC, 19> {
        PR19_W::new(self)
    }
