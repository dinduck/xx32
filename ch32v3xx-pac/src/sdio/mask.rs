...
#[doc = "Field `DBACKENDIE` reader - Data block end interrupt enable"]
pub type DBACKENDIE_R = crate::BitReader;
#[doc = "Field `DBACKENDIE` writer - Data block end interrupt enable"]
pub type DBACKENDIE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
#[doc = "Field `CEATENDIE` reader - CE-ATA command completion signal received interrupt enable"]
pub type CEATENDIE_R = crate::BitReader;
#[doc = "Field `CEATENDIE` writer - CE-ATA command completion signal received interrupt enable"]
pub type CEATENDIE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dbackendie(&mut self) -> DBACKENDIE_W<MASK_SPEC, 10> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ceatendie(&mut self) -> CEATENDIE_W<MASK_SPEC, 23> {
