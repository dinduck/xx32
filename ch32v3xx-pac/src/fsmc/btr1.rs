...
pub type BUSTURN_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn addset(&mut self) -> ADDSET_W<BTR1_SPEC, 0> {
        ADDSET_W::new(self)
    }
    #[doc = "Bits 4:7 - Address-hold phase duration"]
    #[inline(always)]
    #[must_use]
    pub fn addhld(&mut self) -> ADDHLD_W<BTR1_SPEC, 4> {
        ADDHLD_W::new(self)
    }
    #[doc = "Bits 8:15 - Data-phase duration"]
    #[inline(always)]
    #[must_use]
    pub fn datast(&mut self) -> DATAST_W<BTR1_SPEC, 8> {
        DATAST_W::new(self)
    }
    #[doc = "Bits 16:19 - Bus turnaround phase duration"]
    #[inline(always)]
    #[must_use]
    pub fn busturn(&mut self) -> BUSTURN_W<BTR1_SPEC, 16> {
        BUSTURN_W::new(self)
    }
    #[doc = "Bits 20:23 - Clock divide ratio (for FSMC_CLK signal)"]
    #[inline(always)]
    #[must_use]
    pub fn clkdiv(&mut self) -> CLKDIV_W<BTR1_SPEC, 20> {
        CLKDIV_W::new(self)
    }
    #[doc = "Bits 24:27 - Data latency for synchronous NOR Flash memory"]
    #[inline(always)]
    #[must_use]
    pub fn datlat(&mut self) -> DATLAT_W<BTR1_SPEC, 24> {
        DATLAT_W::new(self)
    }
    #[doc = "Bits 28:29 - Access mode"]
    #[inline(always)]
    #[must_use]
    pub fn accmod(&mut self) -> ACCMOD_W<BTR1_SPEC, 28> {
        ACCMOD_W::new(self)
    }
