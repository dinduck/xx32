...
pub type CC2NE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CC3E_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CC3P_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CC3NE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CC3NP_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CC4E_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CC4P_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc2e(&mut self) -> CC2E_W<CCER_SPEC, 4> {
        CC2E_W::new(self)
    }
    #[doc = "Bit 5 - Capture/Compare 2 output Polarity"]
    #[inline(always)]
    #[must_use]
    pub fn cc2p(&mut self) -> CC2P_W<CCER_SPEC, 5> {
        CC2P_W::new(self)
    }
    #[doc = "Bit 6 - Capture/Compare 2 complementary output enable"]
    #[inline(always)]
    #[must_use]
    pub fn cc2ne(&mut self) -> CC2NE_W<CCER_SPEC, 6> {
        CC2NE_W::new(self)
    }
    #[doc = "Bit 7 - Capture/Compare 2 output Polarity"]
    #[inline(always)]
    #[must_use]
    pub fn cc2np(&mut self) -> CC2NP_W<CCER_SPEC, 7> {
        CC2NP_W::new(self)
    }
    #[doc = "Bit 8 - Capture/Compare 3 output enable"]
    #[inline(always)]
    #[must_use]
    pub fn cc3e(&mut self) -> CC3E_W<CCER_SPEC, 8> {
        CC3E_W::new(self)
    }
    #[doc = "Bit 9 - Capture/Compare 3 output Polarity"]
    #[inline(always)]
    #[must_use]
    pub fn cc3p(&mut self) -> CC3P_W<CCER_SPEC, 9> {
        CC3P_W::new(self)
    }
    #[doc = "Bit 10 - Capture/Compare 3 complementary output enable"]
    #[inline(always)]
    #[must_use]
    pub fn cc3ne(&mut self) -> CC3NE_W<CCER_SPEC, 10> {
        CC3NE_W::new(self)
    }
    #[doc = "Bit 11 - Capture/Compare 3 output Polarity"]
    #[inline(always)]
    #[must_use]
    pub fn cc3np(&mut self) -> CC3NP_W<CCER_SPEC, 11> {
        CC3NP_W::new(self)
    }
    #[doc = "Bit 12 - Capture/Compare 4 output enable"]
    #[inline(always)]
    #[must_use]
    pub fn cc4e(&mut self) -> CC4E_W<CCER_SPEC, 12> {
        CC4E_W::new(self)
    }
    #[doc = "Bit 13 - Capture/Compare 3 output Polarity"]
    #[inline(always)]
    #[must_use]
    pub fn cc4p(&mut self) -> CC4P_W<CCER_SPEC, 13> {
        CC4P_W::new(self)
    }
