...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ois1(&mut self) -> OIS1_W<CTLR2_SPEC, 8> {
        OIS1_W::new(self)
    }
    #[doc = "Bit 9 - Output Idle state 1"]
    #[inline(always)]
    #[must_use]
    pub fn ois1n(&mut self) -> OIS1N_W<CTLR2_SPEC, 9> {
        OIS1N_W::new(self)
    }
    #[doc = "Bit 10 - Output Idle state 2"]
    #[inline(always)]
    #[must_use]
    pub fn ois2(&mut self) -> OIS2_W<CTLR2_SPEC, 10> {
        OIS2_W::new(self)
    }
    #[doc = "Bit 11 - Output Idle state 2"]
    #[inline(always)]
    #[must_use]
    pub fn ois2n(&mut self) -> OIS2N_W<CTLR2_SPEC, 11> {
        OIS2N_W::new(self)
    }
    #[doc = "Bit 12 - Output Idle state 3"]
    #[inline(always)]
    #[must_use]
    pub fn ois3(&mut self) -> OIS3_W<CTLR2_SPEC, 12> {
        OIS3_W::new(self)
    }
    #[doc = "Bit 13 - Output Idle state 3"]
    #[inline(always)]
    #[must_use]
    pub fn ois3n(&mut self) -> OIS3N_W<CTLR2_SPEC, 13> {
        OIS3N_W::new(self)
    }
    #[doc = "Bit 14 - Output Idle state 4"]
    #[inline(always)]
    #[must_use]
    pub fn ois4(&mut self) -> OIS4_W<CTLR2_SPEC, 14> {
        OIS4_W::new(self)
    }
