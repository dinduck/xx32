...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn berr(&mut self) -> BERR_W<STAR1_SPEC, 8> {
        BERR_W::new(self)
    }
    #[doc = "Bit 9 - Arbitration lost (master mode)"]
    #[inline(always)]
    #[must_use]
    pub fn arlo(&mut self) -> ARLO_W<STAR1_SPEC, 9> {
        ARLO_W::new(self)
    }
    #[doc = "Bit 10 - Acknowledge failure"]
    #[inline(always)]
    #[must_use]
    pub fn af(&mut self) -> AF_W<STAR1_SPEC, 10> {
        AF_W::new(self)
    }
    #[doc = "Bit 11 - Overrun/Underrun"]
    #[inline(always)]
    #[must_use]
    pub fn ovr(&mut self) -> OVR_W<STAR1_SPEC, 11> {
        OVR_W::new(self)
    }
    #[doc = "Bit 12 - PEC Error in reception"]
    #[inline(always)]
    #[must_use]
    pub fn pecerr(&mut self) -> PECERR_W<STAR1_SPEC, 12> {
        PECERR_W::new(self)
    }
    #[doc = "Bit 14 - Timeout or Tlow error"]
    #[inline(always)]
    #[must_use]
    pub fn timeout(&mut self) -> TIMEOUT_W<STAR1_SPEC, 14> {
        TIMEOUT_W::new(self)
    }
    #[doc = "Bit 15 - SMBus alert"]
    #[inline(always)]
    #[must_use]
    pub fn smbalert(&mut self) -> SMBALERT_W<STAR1_SPEC, 15> {
        SMBALERT_W::new(self)
    }
