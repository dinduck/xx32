...
pub type DIV_FRACTION_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
...
pub type DIV_MANTISSA_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 12, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn div_fraction(&mut self) -> DIV_FRACTION_W<BRR_SPEC, 0> {
        DIV_FRACTION_W::new(self)
    }
    #[doc = "Bits 4:15 - mantissa of USARTDIV"]
    #[inline(always)]
    #[must_use]
    pub fn div_mantissa(&mut self) -> DIV_MANTISSA_W<BRR_SPEC, 4> {
