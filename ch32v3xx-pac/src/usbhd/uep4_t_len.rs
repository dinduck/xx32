...
pub type UEP4_T_LEN_R = crate::FieldReader<u16>;
#[doc = "Field `UEP4_T_LEN` writer - endpoint 0 send the length"]
pub type UEP4_T_LEN_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 11, O, u16>;
impl R {
    #[doc = "Bits 0:10 - endpoint 0 send the length"]
    #[inline(always)]
    pub fn uep4_t_len(&self) -> UEP4_T_LEN_R {
        UEP4_T_LEN_R::new(self.bits & 0x07ff)
    }
}
impl W {
    #[doc = "Bits 0:10 - endpoint 0 send the length"]
    #[inline(always)]
    #[must_use]
    pub fn uep4_t_len(&mut self) -> UEP4_T_LEN_W<UEP4_T_LEN_SPEC, 0> {
