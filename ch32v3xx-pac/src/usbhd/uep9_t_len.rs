...
pub type R = crate::R<UEP9_T_LEN_SPEC>;
#[doc = "Register `UEP9_T_LEN` writer"]
pub type W = crate::W<UEP9_T_LEN_SPEC>;
#[doc = "Field `UEP9_T_LEN` reader - endpoint 9 send the length"]
pub type UEP9_T_LEN_R = crate::FieldReader<u16>;
#[doc = "Field `UEP9_T_LEN` writer - endpoint 9 send the length"]
pub type UEP9_T_LEN_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 11, O, u16>;
impl R {
    #[doc = "Bits 0:10 - endpoint 9 send the length"]
    #[inline(always)]
    pub fn uep9_t_len(&self) -> UEP9_T_LEN_R {
        UEP9_T_LEN_R::new(self.bits & 0x07ff)
    }
}
impl W {
    #[doc = "Bits 0:10 - endpoint 9 send the length"]
    #[inline(always)]
    #[must_use]
    pub fn uep9_t_len(&mut self) -> UEP9_T_LEN_W<UEP9_T_LEN_SPEC, 0> {
...
#[doc = "endpoint9 send the length\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`uep9_t_len::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`uep9_t_len::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
