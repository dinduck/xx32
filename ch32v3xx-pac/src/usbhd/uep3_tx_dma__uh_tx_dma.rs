...
pub type R = crate::R<UEP3_TX_DMA__UH_TX_DMA_SPEC>;
#[doc = "Register `UEP3_TX_DMA__UH_TX_DMA` writer"]
pub type W = crate::W<UEP3_TX_DMA__UH_TX_DMA_SPEC>;
#[doc = "Field `UEP3_TX_DMA__UH_TX_DMA` reader - endpoint 3 DMA buffer address"]
pub type UEP3_TX_DMA__UH_TX_DMA_R = crate::FieldReader<u16>;
#[doc = "Field `UEP3_TX_DMA__UH_TX_DMA` writer - endpoint 3 DMA buffer address"]
pub type UEP3_TX_DMA__UH_TX_DMA_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
impl R {
    #[doc = "Bits 0:15 - endpoint 3 DMA buffer address"]
    #[inline(always)]
    pub fn uep3_tx_dma__uh_tx_dma(&self) -> UEP3_TX_DMA__UH_TX_DMA_R {
        UEP3_TX_DMA__UH_TX_DMA_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:15 - endpoint 3 DMA buffer address"]
    #[inline(always)]
    #[must_use]
    pub fn uep3_tx_dma__uh_tx_dma(
        &mut self,
    ) -> UEP3_TX_DMA__UH_TX_DMA_W<UEP3_TX_DMA__UH_TX_DMA_SPEC, 0> {
...
#[doc = "endpoint 3 DMA TX buffer address\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`uep3_tx_dma__uh_tx_dma::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`uep3_tx_dma__uh_tx_dma::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
