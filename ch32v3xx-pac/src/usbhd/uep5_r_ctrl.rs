...
pub type R = crate::R<UEP5_R_CTRL_SPEC>;
#[doc = "Register `UEP5_R_CTRL` writer"]
pub type W = crate::W<UEP5_R_CTRL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mask_uep_r_res(&mut self) -> MASK_UEP_R_RES_W<UEP5_R_CTRL_SPEC, 0> {
        MASK_UEP_R_RES_W::new(self)
    }
    #[doc = "Bits 3:4 - endpoint 5 synchronous trigger bit for the accept to prepare"]
    #[inline(always)]
    #[must_use]
    pub fn mask_uep_r_tog(&mut self) -> MASK_UEP_R_TOG_W<UEP5_R_CTRL_SPEC, 3> {
...
#[doc = "endpoint 5 send control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`uep5_r_ctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`uep5_r_ctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
