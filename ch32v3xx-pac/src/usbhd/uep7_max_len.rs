...
pub type UEP7_MAX_LEN_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 11, O, u16>;
impl R {
    #[doc = "Bits 0:10 - endpoint 7 max acceptable length"]
    #[inline(always)]
    pub fn uep7_max_len(&self) -> UEP7_MAX_LEN_R {
        UEP7_MAX_LEN_R::new(self.bits & 0x07ff)
    }
}
impl W {
    #[doc = "Bits 0:10 - endpoint 7 max acceptable length"]
    #[inline(always)]
    #[must_use]
    pub fn uep7_max_len(&mut self) -> UEP7_MAX_LEN_W<UEP7_MAX_LEN_SPEC, 0> {
