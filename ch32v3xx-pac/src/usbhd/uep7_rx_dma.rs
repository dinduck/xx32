...
pub type UEP7_RX_DMA_R = crate::FieldReader<u16>;
#[doc = "Field `UEP7_RX_DMA` writer - endpoint 7 DMA buffer address"]
pub type UEP7_RX_DMA_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
impl R {
    #[doc = "Bits 0:15 - endpoint 7 DMA buffer address"]
    #[inline(always)]
    pub fn uep7_rx_dma(&self) -> UEP7_RX_DMA_R {
        UEP7_RX_DMA_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:15 - endpoint 7 DMA buffer address"]
    #[inline(always)]
    #[must_use]
    pub fn uep7_rx_dma(&mut self) -> UEP7_RX_DMA_W<UEP7_RX_DMA_SPEC, 0> {
