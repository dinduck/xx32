...
pub type UEP3_RX_DMA_R = crate::FieldReader<u16>;
#[doc = "Field `UEP3_RX_DMA` writer - endpoint 3 DMA buffer address"]
pub type UEP3_RX_DMA_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
impl R {
    #[doc = "Bits 0:15 - endpoint 3 DMA buffer address"]
    #[inline(always)]
    pub fn uep3_rx_dma(&self) -> UEP3_RX_DMA_R {
        UEP3_RX_DMA_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:15 - endpoint 3 DMA buffer address"]
    #[inline(always)]
    #[must_use]
    pub fn uep3_rx_dma(&mut self) -> UEP3_RX_DMA_W<UEP3_RX_DMA_SPEC, 0> {
