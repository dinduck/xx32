...
pub type R = crate::R<UEP12_T_LEN_SPEC>;
#[doc = "Register `UEP12_T_LEN` writer"]
pub type W = crate::W<UEP12_T_LEN_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn uep0_t_len(&mut self) -> UEP0_T_LEN_W<UEP12_T_LEN_SPEC, 0> {
...
#[doc = "endpoint 12 send the length\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`uep12_t_len::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`uep12_t_len::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
