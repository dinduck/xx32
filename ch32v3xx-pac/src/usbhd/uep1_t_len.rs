...
pub type UEP1_T_LEN_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 11, O, u16>;
impl R {
    #[doc = "Bits 0:10 - endpoint 1 send the length"]
    #[inline(always)]
    pub fn uep1_t_len(&self) -> UEP1_T_LEN_R {
        UEP1_T_LEN_R::new(self.bits & 0x07ff)
    }
}
impl W {
    #[doc = "Bits 0:10 - endpoint 1 send the length"]
    #[inline(always)]
    #[must_use]
    pub fn uep1_t_len(&mut self) -> UEP1_T_LEN_W<UEP1_T_LEN_SPEC, 0> {
