...
pub type R = crate::R<UEP6_T_CTRL_SPEC>;
#[doc = "Register `UEP6_T_CTRL` writer"]
pub type W = crate::W<UEP6_T_CTRL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mask_uep_t_res(&mut self) -> MASK_UEP_T_RES_W<UEP6_T_CTRL_SPEC, 0> {
        MASK_UEP_T_RES_W::new(self)
    }
    #[doc = "Bits 3:4 - endpoint 6 synchronous trigger bit for the sender to prepare"]
    #[inline(always)]
    #[must_use]
    pub fn mask_uep_t_tog(&mut self) -> MASK_UEP_T_TOG_W<UEP6_T_CTRL_SPEC, 3> {
        MASK_UEP_T_TOG_W::new(self)
    }
    #[doc = "Bit 5 - endpoint 6 synchronous trigger bit automatic filp enables the control bit"]
    #[inline(always)]
    #[must_use]
    pub fn b_uep_t_tog_auto(&mut self) -> B_UEP_T_TOG_AUTO_W<UEP6_T_CTRL_SPEC, 5> {
...
#[doc = "endpoint 6 send control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`uep6_t_ctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`uep6_t_ctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
