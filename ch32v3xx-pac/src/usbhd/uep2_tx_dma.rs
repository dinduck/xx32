...
pub type UEP2_TX_DMA_R = crate::FieldReader<u16>;
#[doc = "Field `UEP2_TX_DMA` writer - endpoint 2 DMA buffer address"]
pub type UEP2_TX_DMA_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
impl R {
    #[doc = "Bits 0:15 - endpoint 2 DMA buffer address"]
    #[inline(always)]
    pub fn uep2_tx_dma(&self) -> UEP2_TX_DMA_R {
        UEP2_TX_DMA_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:15 - endpoint 2 DMA buffer address"]
    #[inline(always)]
    #[must_use]
    pub fn uep2_tx_dma(&mut self) -> UEP2_TX_DMA_W<UEP2_TX_DMA_SPEC, 0> {
