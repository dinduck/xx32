...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn data4(&mut self) -> DATA4_W<TXMDHR1_SPEC, 0> {
        DATA4_W::new(self)
    }
    #[doc = "Bits 8:15 - Data byte 5"]
    #[inline(always)]
    #[must_use]
    pub fn data5(&mut self) -> DATA5_W<TXMDHR1_SPEC, 8> {
        DATA5_W::new(self)
    }
    #[doc = "Bits 16:23 - Data byte 6"]
    #[inline(always)]
    #[must_use]
    pub fn data6(&mut self) -> DATA6_W<TXMDHR1_SPEC, 16> {
        DATA6_W::new(self)
    }
    #[doc = "Bits 24:31 - Data byte 7"]
    #[inline(always)]
    #[must_use]
    pub fn data7(&mut self) -> DATA7_W<TXMDHR1_SPEC, 24> {
        DATA7_W::new(self)
    }
