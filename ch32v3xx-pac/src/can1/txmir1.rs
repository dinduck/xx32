...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn txrq(&mut self) -> TXRQ_W<TXMIR1_SPEC, 0> {
        TXRQ_W::new(self)
    }
    #[doc = "Bit 1 - Remote transmission request"]
    #[inline(always)]
    #[must_use]
    pub fn rtr(&mut self) -> RTR_W<TXMIR1_SPEC, 1> {
        RTR_W::new(self)
    }
    #[doc = "Bit 2 - Identifier extension"]
    #[inline(always)]
    #[must_use]
    pub fn ide(&mut self) -> IDE_W<TXMIR1_SPEC, 2> {
        IDE_W::new(self)
    }
    #[doc = "Bits 3:20 - extended identifier"]
    #[inline(always)]
    #[must_use]
    pub fn exid(&mut self) -> EXID_W<TXMIR1_SPEC, 3> {
        EXID_W::new(self)
    }
    #[doc = "Bits 21:31 - Standard identifier"]
    #[inline(always)]
    #[must_use]
    pub fn stid(&mut self) -> STID_W<TXMIR1_SPEC, 21> {
        STID_W::new(self)
    }
