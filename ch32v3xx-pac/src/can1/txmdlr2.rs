...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn data0(&mut self) -> DATA0_W<TXMDLR2_SPEC, 0> {
        DATA0_W::new(self)
    }
    #[doc = "Bits 8:15 - Data byte 1"]
    #[inline(always)]
    #[must_use]
    pub fn data1(&mut self) -> DATA1_W<TXMDLR2_SPEC, 8> {
        DATA1_W::new(self)
    }
    #[doc = "Bits 16:23 - Data byte 2"]
    #[inline(always)]
    #[must_use]
    pub fn data2(&mut self) -> DATA2_W<TXMDLR2_SPEC, 16> {
        DATA2_W::new(self)
    }
    #[doc = "Bits 24:31 - Data byte 3"]
    #[inline(always)]
    #[must_use]
    pub fn data3(&mut self) -> DATA3_W<TXMDLR2_SPEC, 24> {
        DATA3_W::new(self)
    }
