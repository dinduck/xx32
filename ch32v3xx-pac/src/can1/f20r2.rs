...
pub type R = crate::R<F20R2_SPEC>;
#[doc = "Register `F20R2` writer"]
pub type W = crate::W<F20R2_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fb0(&mut self) -> FB0_W<F20R2_SPEC, 0> {
        FB0_W::new(self)
    }
    #[doc = "Bit 1 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb1(&mut self) -> FB1_W<F20R2_SPEC, 1> {
        FB1_W::new(self)
    }
    #[doc = "Bit 2 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb2(&mut self) -> FB2_W<F20R2_SPEC, 2> {
        FB2_W::new(self)
    }
    #[doc = "Bit 3 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb3(&mut self) -> FB3_W<F20R2_SPEC, 3> {
        FB3_W::new(self)
    }
    #[doc = "Bit 4 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb4(&mut self) -> FB4_W<F20R2_SPEC, 4> {
        FB4_W::new(self)
    }
    #[doc = "Bit 5 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb5(&mut self) -> FB5_W<F20R2_SPEC, 5> {
        FB5_W::new(self)
    }
    #[doc = "Bit 6 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb6(&mut self) -> FB6_W<F20R2_SPEC, 6> {
        FB6_W::new(self)
    }
    #[doc = "Bit 7 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb7(&mut self) -> FB7_W<F20R2_SPEC, 7> {
        FB7_W::new(self)
    }
    #[doc = "Bit 8 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb8(&mut self) -> FB8_W<F20R2_SPEC, 8> {
        FB8_W::new(self)
    }
    #[doc = "Bit 9 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb9(&mut self) -> FB9_W<F20R2_SPEC, 9> {
        FB9_W::new(self)
    }
    #[doc = "Bit 10 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb10(&mut self) -> FB10_W<F20R2_SPEC, 10> {
        FB10_W::new(self)
    }
    #[doc = "Bit 11 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb11(&mut self) -> FB11_W<F20R2_SPEC, 11> {
        FB11_W::new(self)
    }
    #[doc = "Bit 12 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb12(&mut self) -> FB12_W<F20R2_SPEC, 12> {
        FB12_W::new(self)
    }
    #[doc = "Bit 13 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb13(&mut self) -> FB13_W<F20R2_SPEC, 13> {
        FB13_W::new(self)
    }
    #[doc = "Bit 14 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb14(&mut self) -> FB14_W<F20R2_SPEC, 14> {
        FB14_W::new(self)
    }
    #[doc = "Bit 15 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb15(&mut self) -> FB15_W<F20R2_SPEC, 15> {
        FB15_W::new(self)
    }
    #[doc = "Bit 16 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb16(&mut self) -> FB16_W<F20R2_SPEC, 16> {
        FB16_W::new(self)
    }
    #[doc = "Bit 17 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb17(&mut self) -> FB17_W<F20R2_SPEC, 17> {
        FB17_W::new(self)
    }
    #[doc = "Bit 18 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb18(&mut self) -> FB18_W<F20R2_SPEC, 18> {
        FB18_W::new(self)
    }
    #[doc = "Bit 19 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb19(&mut self) -> FB19_W<F20R2_SPEC, 19> {
        FB19_W::new(self)
    }
    #[doc = "Bit 20 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb20(&mut self) -> FB20_W<F20R2_SPEC, 20> {
        FB20_W::new(self)
    }
    #[doc = "Bit 21 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb21(&mut self) -> FB21_W<F20R2_SPEC, 21> {
        FB21_W::new(self)
    }
    #[doc = "Bit 22 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb22(&mut self) -> FB22_W<F20R2_SPEC, 22> {
        FB22_W::new(self)
    }
    #[doc = "Bit 23 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb23(&mut self) -> FB23_W<F20R2_SPEC, 23> {
        FB23_W::new(self)
    }
    #[doc = "Bit 24 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb24(&mut self) -> FB24_W<F20R2_SPEC, 24> {
        FB24_W::new(self)
    }
    #[doc = "Bit 25 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb25(&mut self) -> FB25_W<F20R2_SPEC, 25> {
        FB25_W::new(self)
    }
    #[doc = "Bit 26 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb26(&mut self) -> FB26_W<F20R2_SPEC, 26> {
        FB26_W::new(self)
    }
    #[doc = "Bit 27 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb27(&mut self) -> FB27_W<F20R2_SPEC, 27> {
        FB27_W::new(self)
    }
    #[doc = "Bit 28 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb28(&mut self) -> FB28_W<F20R2_SPEC, 28> {
        FB28_W::new(self)
    }
    #[doc = "Bit 29 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb29(&mut self) -> FB29_W<F20R2_SPEC, 29> {
        FB29_W::new(self)
    }
    #[doc = "Bit 30 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb30(&mut self) -> FB30_W<F20R2_SPEC, 30> {
        FB30_W::new(self)
    }
    #[doc = "Bit 31 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb31(&mut self) -> FB31_W<F20R2_SPEC, 31> {
        FB31_W::new(self)
    }
...
#[doc = "Filter bank 20 register 2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`f20r2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`f20r2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
