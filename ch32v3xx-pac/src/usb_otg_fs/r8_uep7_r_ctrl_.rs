...
pub type R = crate::R<R8_UEP7_R_CTRL__SPEC>;
#[doc = "Register `R8_UEP7_R_CTRL_` writer"]
pub type W = crate::W<R8_UEP7_R_CTRL__SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mask_uep_r_res(&mut self) -> MASK_UEP_R_RES_W<R8_UEP7_R_CTRL__SPEC, 0> {
        MASK_UEP_R_RES_W::new(self)
    }
    #[doc = "Bit 2 - expected data toggle flag of USB endpoint X receiving (OUT): 0=DATA0, 1=DATA1"]
    #[inline(always)]
    #[must_use]
    pub fn usbhd_uep_r_tog(&mut self) -> USBHD_UEP_R_TOG_W<R8_UEP7_R_CTRL__SPEC, 2> {
        USBHD_UEP_R_TOG_W::new(self)
    }
    #[doc = "Bit 3 - enable automatic toggle after successful transfer completion on endpoint 1/2/3: 0=manual toggle, 1=automatic toggle"]
    #[inline(always)]
    #[must_use]
    pub fn usbhd_uep_auto_tog(&mut self) -> USBHD_UEP_AUTO_TOG_W<R8_UEP7_R_CTRL__SPEC, 3> {
