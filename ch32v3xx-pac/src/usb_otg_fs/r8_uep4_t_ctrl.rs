...
pub type R = crate::R<R8_UEP4_T_CTRL_SPEC>;
#[doc = "Register `R8_UEP4_T_CTRL` writer"]
pub type W = crate::W<R8_UEP4_T_CTRL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mask_uep_t_res(&mut self) -> MASK_UEP_T_RES_W<R8_UEP4_T_CTRL_SPEC, 0> {
    ...
    pub fn usbhd_uep_t_tog___usbhd_uh_t_tog(
        &mut self,
    ) -> USBHD_UEP_T_TOG___USBHD_UH_T_TOG_W<R8_UEP4_T_CTRL_SPEC, 2> {
    ...
    pub fn usbhd_uep_auto_tog__usbhd_uh_t_auto_tog(
        &mut self,
    ) -> USBHD_UEP_AUTO_TOG__USBHD_UH_T_AUTO_TOG_W<R8_UEP4_T_CTRL_SPEC, 3> {
...
#[doc = "endpoint 4 control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`r8_uep4_t_ctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`r8_uep4_t_ctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
