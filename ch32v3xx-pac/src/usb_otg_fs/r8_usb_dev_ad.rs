...
pub type R = crate::R<R8_USB_DEV_AD_SPEC>;
#[doc = "Register `R8_USB_DEV_AD` writer"]
pub type W = crate::W<R8_USB_DEV_AD_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mask_usb_addr(&mut self) -> MASK_USB_ADDR_W<R8_USB_DEV_AD_SPEC, 0> {
        MASK_USB_ADDR_W::new(self)
    }
    #[doc = "Bit 7 - general purpose bit"]
    #[inline(always)]
    #[must_use]
    pub fn rb_uda_gp_bit(&mut self) -> RB_UDA_GP_BIT_W<R8_USB_DEV_AD_SPEC, 7> {
