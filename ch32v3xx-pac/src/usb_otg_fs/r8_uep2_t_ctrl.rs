...
pub type R = crate::R<R8_UEP2_T_CTRL_SPEC>;
#[doc = "Register `R8_UEP2_T_CTRL` writer"]
pub type W = crate::W<R8_UEP2_T_CTRL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mask_uep_t_res(&mut self) -> MASK_UEP_T_RES_W<R8_UEP2_T_CTRL_SPEC, 0> {
        MASK_UEP_T_RES_W::new(self)
    }
    #[doc = "Bit 2 - prepared data toggle flag of USB endpoint X transmittal (IN): 0=DATA0, 1=DATA1"]
    #[inline(always)]
    #[must_use]
    pub fn usbhd_uep_t_tog_(&mut self) -> USBHD_UEP_T_TOG__W<R8_UEP2_T_CTRL_SPEC, 2> {
        USBHD_UEP_T_TOG__W::new(self)
    }
    #[doc = "Bit 3 - enable automatic toggle after successful transfer completion on endpoint 1/2/3: 0=manual toggle, 1=automatic toggle"]
    #[inline(always)]
    #[must_use]
    pub fn usbhd_uep_auto_tog(&mut self) -> USBHD_UEP_AUTO_TOG_W<R8_UEP2_T_CTRL_SPEC, 3> {
