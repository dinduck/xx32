...
pub type R = crate::R<R8_UEP1_T_CTRL___USBHD_UH_SETUP_SPEC>;
#[doc = "Register `R8_UEP1_T_CTRL___USBHD_UH_SETUP` writer"]
pub type W = crate::W<R8_UEP1_T_CTRL___USBHD_UH_SETUP_SPEC>;
...
pub type USBHD_UEP_T_TOG__R = crate::BitReader;
#[doc = "Field `USBHD_UEP_T_TOG_` writer - prepared data toggle flag of USB endpoint X transmittal (IN): 0=DATA0, 1=DATA1"]
pub type USBHD_UEP_T_TOG__W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mask_uep_t_res(&mut self) -> MASK_UEP_T_RES_W<R8_UEP1_T_CTRL___USBHD_UH_SETUP_SPEC, 0> {
        MASK_UEP_T_RES_W::new(self)
    }
    #[doc = "Bit 2 - prepared data toggle flag of USB endpoint X transmittal (IN): 0=DATA0, 1=DATA1"]
    #[inline(always)]
    #[must_use]
    pub fn usbhd_uep_t_tog_(
        &mut self,
    ) -> USBHD_UEP_T_TOG__W<R8_UEP1_T_CTRL___USBHD_UH_SETUP_SPEC, 2> {
        USBHD_UEP_T_TOG__W::new(self)
    }
    #[doc = "Bit 3 - enable automatic toggle after successful transfer completion on endpoint 1/2/3: 0=manual toggle, 1=automatic toggle"]
    #[inline(always)]
    #[must_use]
    pub fn usbhd_uep_auto_tog(
        &mut self,
    ) -> USBHD_UEP_AUTO_TOG_W<R8_UEP1_T_CTRL___USBHD_UH_SETUP_SPEC, 3> {
        USBHD_UEP_AUTO_TOG_W::new(self)
    }
    #[doc = "Bit 6 - USB host automatic SOF enable"]
    #[inline(always)]
    #[must_use]
    pub fn usbhd_uh_sof_en(
        &mut self,
    ) -> USBHD_UH_SOF_EN_W<R8_UEP1_T_CTRL___USBHD_UH_SETUP_SPEC, 6> {
        USBHD_UH_SOF_EN_W::new(self)
    }
    #[doc = "Bit 7 - USB host PRE PID enable for low speed device via hub"]
    #[inline(always)]
    #[must_use]
    pub fn usbhd_uh_pre_pid_en(
        &mut self,
    ) -> USBHD_UH_PRE_PID_EN_W<R8_UEP1_T_CTRL___USBHD_UH_SETUP_SPEC, 7> {
...
#[doc = "endpoint 1 control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`r8_uep1_t_ctrl___usbhd_uh_setup::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`r8_uep1_t_ctrl___usbhd_uh_setup::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
