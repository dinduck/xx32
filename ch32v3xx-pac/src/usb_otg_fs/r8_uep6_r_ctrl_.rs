...
pub type R = crate::R<R8_UEP6_R_CTRL__SPEC>;
#[doc = "Register `R8_UEP6_R_CTRL_` writer"]
pub type W = crate::W<R8_UEP6_R_CTRL__SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mask_uep_r_res(&mut self) -> MASK_UEP_R_RES_W<R8_UEP6_R_CTRL__SPEC, 0> {
        MASK_UEP_R_RES_W::new(self)
    }
    #[doc = "Bit 2 - expected data toggle flag of USB endpoint X receiving (OUT): 0=DATA0, 1=DATA1"]
    #[inline(always)]
    #[must_use]
    pub fn usbhd_uep_r_tog(&mut self) -> USBHD_UEP_R_TOG_W<R8_UEP6_R_CTRL__SPEC, 2> {
        USBHD_UEP_R_TOG_W::new(self)
    }
    #[doc = "Bit 3 - enable automatic toggle after successful transfer completion on endpoint 1/2/3: 0=manual toggle, 1=automatic toggle"]
    #[inline(always)]
    #[must_use]
    pub fn usbhd_uep_auto_tog(&mut self) -> USBHD_UEP_AUTO_TOG_W<R8_UEP6_R_CTRL__SPEC, 3> {
...
#[doc = "endpoint 6 control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`r8_uep6_r_ctrl_::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`r8_uep6_r_ctrl_::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
